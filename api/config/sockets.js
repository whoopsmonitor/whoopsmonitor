...
module.exports.sockets = {
  ...
  host: process.env.APP_REDIS_SOCKETS_CONNECTION_HOST,
  port: process.env.APP_REDIS_SOCKETS_CONNECTION_PORT,
  pass: process.env.APP_REDIS_SOCKETS_PASSWORD,
  ...
  ***************************************************************************/
  ...
  onlyAllowOrigins: [ 'http://localhost:8080' ]
};
